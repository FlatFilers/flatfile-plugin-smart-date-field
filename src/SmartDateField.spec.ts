...
describe('Extra test ->', () => {
  ...
  const noParse = (d: string) => `Error: '${d}' could not be parsed as a date.`
...
describe('Cast Function tests ->', () => {
  ...
  test('DateCast handles invalid dates as errors', () => {
    assertThrow('2022-07-35', "'2022-07-35' could not be parsed as a date.")
  })

  test('DateCast handles random strings as errors', () => {
    assertThrow('foo', "'foo' could not be parsed as a date.")
  })
